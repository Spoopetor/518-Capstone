    ...
    return <Container fluid className="mx-4"> 
        <Row className="justify-content-center"> 
            ...
            <Row className="justify-content-center">
                ...
                <div className="d-flex align-items-center"> 
                    <span className="p-3">
                        {selectedCountry !== "none" ? <Image src={`https://flagsapi.com/${selectedCountry}/flat/64.png`} alt={`${selectedCountry} Flag`}/> : <Image src="https://raw.githubusercontent.com/Spoopetor/518-Capstone/refs/heads/main/frontend/src/assets/earth.png" alt={`Earth`} style={{width: '64px', height: '64px'}}/>}
                    </span>
                    ...
                    <Dropdown.Toggle variant="success" id="dropdown-country">
                        ...
                        <Dropdown.Menu style={{ maxHeight: '300px', overflowY: 'auto' }}>
                            ...
                            <Dropdown.Item key={code} eventKey={code}>
                                <Container flex>
                                    <span className="p-1">
                                        {code !== "none" ? <Image src={`https://flagsapi.com/${code}/flat/32.png`} alt={`${code} Flag`}/> : <Image src="https://raw.githubusercontent.com/Spoopetor/518-Capstone/refs/heads/main/frontend/src/assets/earth.png" alt={`Earth`} style={{width: '32px', height: '32px'}}/>}
                                    </span>
